...
Before starting work, the setup_env.sh script runs scripts/validate_context.py with the --reconcile flag to automatically check handoff recommendations against the git repository state.

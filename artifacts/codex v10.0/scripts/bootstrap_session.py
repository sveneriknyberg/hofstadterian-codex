...
def main():
    ...
    try:
        # We capture output to show it only on failure.
        ...
        # On success, pre-flight check is silent to the end-user.
    except subprocess.CalledProcessError as e:
        # Pre-flight check script already prints detailed errors to stderr.
        failure_briefing = {
    ...
    briefing = {
        ...
        "message": "Hofstadterian Protocol v10.0 session is active. All rules in AGENTS.md are in effect.",
